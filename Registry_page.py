...
countries = []
variable = StringVar()
world = ("usa","canada","germany","french","island","poland","austoralia")
...
Label(right_frame, text="Select Country", bg='#CCCCCC',font=f).grid(row=4, column=0, sticky=W, pady=10)
...
register_country = OptionMenu(right_frame, variable, *countries,True)
...
register_btn = Button(right_frame, width=15, text='Register', font=f, relief=SOLID,cursor='hand2',command=print(open("new.txt",W)))
