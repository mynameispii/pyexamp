...
fgobutton = Button(app, text = "convert", command = convert_fahr)
fgobutton.grid(row = 0, column = 2, padx = 5, pady = 5, sticky = N+S+E+W)
cgobutton = Button(app, text = "convert", command = convert_cel)
cgobutton.grid(row = 1, column = 2, padx = 5, pady = 5, sticky = N+S+E+W)
kgobutton = Button(app, text = "convert", command = convert_kel)
kgobutton.grid(row = 2, column = 2, padx = 5, pady = 5, sticky = N+S+E+W)
exitbutton = Button(app, text = 'Exit', command = quit)
exitbutton.grid(row = 3, column = 0, padx = 5, pady = 5, sticky = N+S+E+W,
columnspan = 3)
app.mainloop()
